...
class Color {
   ...
   public:
    ...
    static Color Cyan() { return Color(37, 242, 217, 255); }
    ...
    inline bool operator==(const Color& color) { return mColor == color.mColor; }
    inline bool operator!=(const Color& color) { return !(*this == color); }
